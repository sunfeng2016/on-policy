...
class MLPLayer_critic(nn.Module):
    def __init__(self, input_dim, hidden_size, layer_N, use_orthogonal, use_ReLU):
        super(MLPLayer_critic, self).__init__()
        self._layer_N = layer_N
...
class MLPBase_Critic(nn.Module):
    def __init__(self, args, state_shape, cat_self=True, attn_internal=False):
        super(MLPBase_Critic, self).__init__()
        ...
        self.mlp = MLPLayer_critic(state_dim, self.hidden_size,
                              self._layer_N, self._use_orthogonal, self._use_ReLU)
